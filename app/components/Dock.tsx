...
export function Dock() {
  ...
  return (
    <div className={`fixed bottom-4 md:bottom-8 left-1/2 -translate-x-1/2 z-[100] transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] ${showDock ? 'translate-y-0 opacity-100 scale-100' : 'translate-y-24 opacity-0 scale-90 pointer-events-none'}`}>
      <div className="flex items-end gap-1.5 md:gap-2 px-2 md:px-4 py-2 md:py-3 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-[0_20px_40px_rgba(0,0,0,0.4)] h-16 md:h-[72px]">

        {/* Home Icon */}
        <Link to="/" className="group relative flex items-center justify-center w-10 h-10 md:w-12 md:h-12 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-300 hover:w-12 md:hover:w-16 hover:h-12 md:hover:h-16 hover:-translate-y-1.5 md:hover:-translate-y-2 mx-0.5 md:mx-1 border border-white/5 hover:border-white/20 shadow-lg cursor-pointer origin-bottom">
          <svg className="w-5 h-5 md:w-6 md:h-6 group-hover:w-6 md:group-hover:w-8 group-hover:h-6 md:group-hover:h-8 text-slate-300 group-hover:text-purple-400 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
        ...
        {/* About Us Icon */}
        <Link to="/about" className="group relative flex items-center justify-center w-10 h-10 md:w-12 md:h-12 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-300 hover:w-12 md:hover:w-16 hover:h-12 md:hover:h-16 hover:-translate-y-1.5 md:hover:-translate-y-2 mx-0.5 md:mx-1 border border-white/5 hover:border-white/20 shadow-lg cursor-pointer origin-bottom">
        ...
        <div className="group relative mx-0.5 md:mx-1 flex flex-col justify-end">
          {/* The Stack Menu */}
          ...
          {/* Main Services Icon */}
          <button onClick={() => handleNav('services')} className="relative flex items-center justify-center w-10 h-10 md:w-12 md:h-12 rounded-xl bg-white/5 group-hover:bg-white/10 transition-all duration-300 group-hover:w-12 md:group-hover:w-16 group-hover:h-12 md:group-hover:h-16 group-hover:-translate-y-1.5 md:group-hover:-translate-y-2 border border-white/5 group-hover:border-white/20 shadow-lg cursor-pointer origin-bottom">
            <svg className="w-5 h-5 md:w-6 md:h-6 group-hover:w-6 md:group-hover:w-8 group-hover:h-6 md:group-hover:h-8 text-slate-300 group-hover:text-blue-400 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"></path></svg>
          </button>
        </div>

        {/* Portfolio Icon */}
        <Link to="/portfolio" className="group relative flex items-center justify-center w-10 h-10 md:w-12 md:h-12 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-300 hover:w-12 md:hover:w-16 hover:h-12 md:hover:h-16 hover:-translate-y-1.5 md:hover:-translate-y-2 mx-0.5 md:mx-1 border border-white/5 hover:border-white/20 shadow-lg cursor-pointer origin-bottom">
        ...
        {/* Clients Icon */}
        <Link to="/clients" className="group relative flex items-center justify-center w-10 h-10 md:w-12 md:h-12 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-300 hover:w-12 md:hover:w-16 hover:h-12 md:hover:h-16 hover:-translate-y-1.5 md:hover:-translate-y-2 mx-0.5 md:mx-1 border border-white/5 hover:border-white/20 shadow-lg cursor-pointer origin-bottom">
        ...
        {/* Divider */}
        <div className="w-px h-6 md:h-8 bg-white/20 mx-1.5 md:mx-2 self-center"></div>

        {/* Contact Icon */}
        <Link to="/contact" className="group relative flex items-center justify-center w-10 h-10 md:w-12 md:h-12 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-300 hover:w-12 md:hover:w-16 hover:h-12 md:hover:h-16 hover:-translate-y-1.5 md:hover:-translate-y-2 mx-0.5 md:mx-1 border border-white/5 hover:border-white/20 shadow-lg cursor-pointer origin-bottom">
