                    ...
                    <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
                        <div className="w-full lg:w-1/2 space-y-8 relative z-10">
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-indigo-500/30 bg-indigo-500/10 backdrop-blur-md">
                                ...
                                <span className="text-sm font-medium text-indigo-200 tracking-wide">Business Benefit</span>
                            </div>
                            <h1 className="text-5xl lg:text-7xl font-black text-white leading-tight">
                                24/7 <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-blue-400">Availability</span>
                            </h1>
                            <p className="text-xl text-slate-400 leading-relaxed">
                                Business doesn't sleep, and neither should your platform. We build resilient systems with robust failovers that run flawlessly around the clock, ensuring business continuity and peace of mind.
                            </p>
                            <div className="pt-4 flex gap-4">
                                <Link to="/contact" className="px-8 py-4 rounded-full bg-indigo-600 text-white font-semibold hover:bg-indigo-500 transition-all shadow-[0_0_20px_rgba(99,102,241,0.4)]">Ensure Uptime</Link>
                        ...
                        <div className="w-full lg:w-1/2 relative z-10">
                            <div className="relative rounded-3xl overflow-hidden border border-white/10 group">
                                ...
                                <img src="/images/smart-analyzing.png" alt="24/7 Availability and Resilience" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700" />
                            </div>
                        </div>
                    </div>
                </div>
