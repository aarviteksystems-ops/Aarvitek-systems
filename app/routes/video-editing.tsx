import type { Route } from "./+types/video-editing";
...
export default function VideoEditing() {
    ...
    return (
        <div ref={container} className="min-h-screen bg-[#000000] text-slate-300 selection:bg-purple-500/30 overflow-hidden pt-24 pb-12">
            ...
            <div className="absolute top-[20%] right-[-10%] w-[600px] h-[600px] bg-rose-500/10 blur-[180px] rounded-full pointer-events-none"></div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
                        ...
                        <div className="lg:col-span-7 space-y-8 hero-text-animate">
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-purple-500/30 bg-purple-500/10 backdrop-blur-md">
                                ...
                                <span className="text-sm font-semibold text-purple-200 tracking-wide">Cinematic Motion & Post-Production</span>
                            </div>
                            ...
                            <p className="text-lg md:text-xl text-slate-400 max-w-2xl leading-relaxed font-medium">
                                We engineer high-retention video stories. By combining professional timeline sequencing, precise audio enhancement, cinema-grade color styling, and dynamic motion typography overlays, we transform raw rushes into engaging brand assets.
                            </p>

                            {/* SEO Bullet List */}
                            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-slate-300">
                                {[
                                    { text: "Cinematic Color & Grading", desc: "Cohesive lut schemes matching corporate guides" },
                                    { text: "Dynamic Motion & VFX Layers", desc: "Engaging 2D/3D title sequences and tracks" },
                                    { text: "High-Retention Social Formats", desc: "Optimized reels, shorts, and explainer clips" },
                                    { text: "Pristine Sound Design & SFX", desc: "Voice cleaning, licensing, and audio effects" }
                                ].map((item, i) => (
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 pt-4">
                                <Link to="/contact" className="px-8 py-4 rounded-full bg-purple-600 text-white font-semibold text-lg hover:bg-purple-500 transition-all text-center shadow-[0_0_20px_rgba(168,85,247,0.4)] hover:shadow-[0_0_30px_rgba(168,85,247,0.6)]">
                                    Schedule Visual Consult
                                </Link>
                                <a href="#editing-process" className="px-8 py-4 rounded-full bg-transparent border border-white/20 text-white font-semibold text-lg hover:bg-white/5 transition-all text-center">
                                    Our Creative Process
                                </a>
                            </div>
                        </div>

                        {/* Right Column: Timeline Artboard Mockup */}
                        <div className="lg:col-span-5 relative hero-visual-animate">
                            
                            {/* Ambient glow backdrop */}
                            <div className="absolute inset-0 bg-gradient-to-tr from-purple-500/10 to-rose-500/10 blur-3xl -z-10 rounded-full"></div>

                            {/* Editing Workspace Mockup */}
                            <div className="relative rounded-[2rem] border border-white/10 bg-[#0a0a0a]/80 backdrop-blur-xl shadow-[0_30px_60px_rgba(0,0,0,0.8)] overflow-hidden group">
                                ...
                                <div className="flex items-center justify-between px-6 py-4 border-b border-white/5 bg-white/[0.02]">
                                    ...
                                    <div className="px-4 py-1 rounded-lg bg-white/5 border border-white/5 text-[10px] text-slate-500 font-mono tracking-wider w-64 text-center truncate">
                                        video_timeline_v4.prproj (4K UHD)
                                    </div>
                                ...
                                <div className="aspect-[4/3] relative overflow-hidden bg-gradient-to-br from-purple-950/20 to-rose-950/20 flex items-center justify-center">
                                    ...
                                    <div className="absolute bottom-4 left-4 right-4 h-16 bg-black/60 backdrop-blur-md rounded-xl border border-white/5 p-3 flex flex-col justify-between overflow-hidden">
                                        <div className="flex gap-1 h-3 items-center">
                                            <div className="w-16 h-2 bg-purple-500/60 rounded"></div>
                                            <div className="w-24 h-2 bg-pink-500/60 rounded"></div>
                                            <div className="w-8 h-2 bg-violet-500/60 rounded"></div>
                                        </div>
                                        <div className="flex gap-1 h-3 items-center">
                                            <div className="w-32 h-2 bg-teal-500/40 rounded"></div>
                                            <div className="w-12 h-2 bg-emerald-500/40 rounded"></div>
                                        </div>
                                    </div>
                            ...
                            {/* Floating Widget 1: Render Quality */}
                            <div className="absolute -top-6 -right-6 md:-right-8 p-4 rounded-2xl border border-white/15 bg-[#0d0d0d]/90 backdrop-blur-md shadow-2xl flex items-center gap-4 animate-[bounce_4s_infinite_ease-in-out]">
                                <div className="w-10 h-10 rounded-full bg-purple-500/20 flex items-center justify-center border border-purple-500/30">
                                    <span className="text-xs font-black text-purple-400">4K</span>
                                </div>
                                <div>
                                    <span className="block text-white font-extrabold text-xs tracking-wider uppercase">Resolution</span>
                                    <span className="block text-slate-400 text-[10px]">UHD 60FPS Lossless</span>
                                </div>
                            </div>

                            {/* Floating Widget 2: Engagement Index */}
                            <div className="absolute -bottom-6 -left-6 md:-left-8 p-4 rounded-2xl border border-white/15 bg-[#0d0d0d]/90 backdrop-blur-md shadow-2xl flex items-center gap-4 animate-[bounce_5s_infinite_ease-in-out_1s]">
                                <div className="w-12 h-12 rounded-full bg-pink-500/20 flex items-center justify-center border border-pink-500/30 relative">
                                    <span className="text-xs font-black text-pink-400">+85%</span>
                                </div>
                                <div>
                                    <span className="block text-white font-extrabold text-xs tracking-wider uppercase">User retention</span>
                                    <span className="block text-slate-400 text-[10px]">Average organic lift</span>
                                </div>
                            </div>
                        </div>
            ...
            {/* Retention Stats banner */}
            <section className="py-8 bg-white/[0.02] border-y border-white/5 relative z-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 items-center justify-items-center">
                        {[
                            { value: "85%", label: "Average retention lift" },
                            { value: "4K UHD", label: "Lossless Export Resolution" },
                            { value: "10x", label: "Organic views potential" },
                            { value: "Stereo/5.1", label: "High-Fidelity Audio mix" }
                        ].map((stat, i) => (
                            <div key={i} className="text-center">
                                <span className="block text-2xl md:text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">{stat.value}</span>
            ...
            {/* 2. Custom Video Capabilities (Improved Cards) */}
            <section className="py-24 relative z-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    
                    <div className="text-center max-w-3xl mx-auto mb-20">
                        <h2 className="text-3xl md:text-5xl font-black tracking-tight text-white mb-6">
                            Tailored Visual Post-Production
                        </h2>
                        <p className="text-slate-400 text-lg leading-relaxed">
                            We don't do simple templates cut. We map custom timeline cuts, color settings, and motion graphics tailored completely to capture viewer attention instantly.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            <div key={idx} className="reveal-card">
                                <div className="relative group rounded-3xl p-[1px] overflow-hidden transition-all duration-300 transform hover:scale-[1.03] hover:shadow-[0_0_30px_rgba(168,85,247,0.12)] h-full bg-white/5 border border-white/5 hover:border-transparent">
                                    ...
                                    <div className="relative h-full bg-[#0a0a0a] rounded-[23px] p-6 md:p-8 z-10 flex flex-col justify-between overflow-hidden">
                                        ...
                                        <div className="space-y-6">
                                            {/* icon wrapper */}
                                            <div className="w-12 h-12 bg-purple-500/10 rounded-xl flex items-center justify-center border border-purple-500/20 group-hover:bg-purple-600 group-hover:border-purple-400 group-hover:shadow-[0_0_15px_rgba(168,85,247,0.3)] transition-all duration-300">
                                                <svg className="w-6 h-6 text-purple-400 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d={card.icon}></path></svg>
                                            </div>
                                        ...
                                        <div className="pt-6 mt-6 border-t border-white/5 flex items-center justify-between">
                                            <span className="text-[10px] font-mono uppercase tracking-wider text-slate-500">Service:</span>
                                            <span className="text-[11px] font-semibold text-purple-400 bg-purple-500/5 border border-purple-500/10 px-2.5 py-0.5 rounded-md">{card.tag}</span>
                                        </div>
            ...
            <section id="tools" className="py-24 bg-[#050505] border-y border-white/5 relative z-10 tool-section-trigger">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="text-center max-w-3xl mx-auto mb-20">
                        <h2 className="text-3xl md:text-5xl font-black tracking-tight text-white mb-6">
                            Our Editing & Motion Stack
                        </h2>
                        <p className="text-slate-400 text-lg leading-relaxed">
                            We use advanced, professional systems to sequence clips, grade color values, and compose motion titles.
                        </p>
                    </div>

                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                        {[
                            { name: "Premiere Pro", type: "Timeline Assembly", glow: "hover:shadow-[0_0_20px_rgba(153,102,255,0.2)] hover:border-purple-500/40", icon: "Pr" },
                            { name: "After Effects", type: "Motion Graphics", glow: "hover:shadow-[0_0_20px_rgba(153,153,255,0.2)] hover:border-indigo-500/40", icon: "Ae" },
                            { name: "DaVinci Resolve", type: "Color Styling", glow: "hover:shadow-[0_0_20px_rgba(255,102,0,0.2)] hover:border-amber-500/40", icon: "Dr" },
                            { name: "Audition", type: "Audio Mastering", glow: "hover:shadow-[0_0_20px_rgba(0,255,204,0.2)] hover:border-teal-500/40", icon: "Au" },
                            { name: "Figma", type: "Vector Layouts", glow: "hover:shadow-[0_0_20px_rgba(242,78,30,0.2)] hover:border-orange-500/40", icon: "Fi" },
                            { name: "Photoshop", type: "Graphic Assests", glow: "hover:shadow-[0_0_20px_rgba(49,168,255,0.2)] hover:border-sky-500/40", icon: "Ps" }
                        ].map((tool, idx) => (
            ...
            {/* 4. Interactive Editing Roadmap / Process (Step-by-step) */}
            <section id="editing-process" className="py-24 relative z-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    
                    <div className="text-center max-w-3xl mx-auto mb-20">
                        <h2 className="text-3xl md:text-5xl font-black tracking-tight text-white mb-6">
                            Structured Video Pipeline
                        </h2>
                        <p className="text-slate-400 text-lg leading-relaxed">
                            A highly organized four-step creation pipeline ensuring your digital media hooks viewer attention instantly.
                        </p>
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            { num: "01", step: "Asset Scoping & Story", desc: "Analyzing target timelines, organizing raw rushes, writing narration scripts, and planning background scores." },
                            { num: "02", step: "A-Roll Assembly & Cuts", desc: "Trimming dead space, arranging visual hooks in the initial 3 seconds, and sequencing A-Roll narrative maps." },
                            { num: "03", step: "Color Grade & Motion VFX", desc: "Injecting kinetic captions, adding custom shape transitions, grading footage logs, and layering audio SFX." },
                            { num: "04", step: "Client Review & UHD Export", desc: "Delivering review cuts via Frame.io, integrating feedback edits, and exporting in lossless 4K UHD profiles." }
                        ].map((phase, idx) => (
            ...
            <section className="py-12 relative z-10">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="relative rounded-[2.5rem] overflow-hidden p-12 md:p-20 text-center border border-white/10 bg-gradient-to-br from-[#12051a] to-[#04010a] shadow-2xl">
                        ...
                        <div className="absolute bottom-[-30%] left-[-10%] w-[300px] h-[300px] bg-rose-500/20 blur-[80px] rounded-full pointer-events-none"></div>
                        ...
                        <div className="relative z-10 max-w-3xl mx-auto space-y-6">
                            ...
                            <p className="text-slate-400 text-base md:text-lg leading-relaxed max-w-2xl mx-auto">
                                Let's build a custom premium video editing package to supercharge your YouTube channel, B2B explainers, or social media retention rates.
                            </p>
                            <div className="pt-6">
                                <Link 
                                    to="/contact" 
                                ...
                                >
                                    Get a Free 15-Second Audition Video Cut
                                </Link>
                            </div>
                        </div>
                    </div>
