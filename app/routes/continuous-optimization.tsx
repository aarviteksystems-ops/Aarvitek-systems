...
export default function ContinuousOptimization() {
    return (
                    ...
                    <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
                        <div className="w-full lg:w-1/2 space-y-8 relative z-10">
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 backdrop-blur-md">
                                ...
                                <span className="text-sm font-medium text-emerald-200 tracking-wide">Phase 04</span>
                            </div>
                            <h1 className="text-5xl lg:text-7xl font-black text-white leading-tight">
                                Continuous <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-400">Optimization</span>
                            </h1>
                            <p className="text-xl text-slate-400 leading-relaxed">
                                Our job doesn't end at launch. We provide ongoing monitoring, proactive maintenance, and continuous optimization to ensure your systems are consistently high-performing, secure, and future-proofed against evolving technologies.
                            </p>
                            <div className="pt-4 flex gap-4">
                                <Link to="/contact" className="px-8 py-4 rounded-full bg-emerald-600 text-white font-semibold hover:bg-emerald-500 transition-all shadow-[0_0_20px_rgba(16,185,129,0.4)]">Consult With Us</Link>
                        ...
                        <div className="w-full lg:w-1/2 relative z-10">
                            <div className="relative rounded-3xl overflow-hidden border border-white/10 group">
                                ...
                                <img src="/images/continuous-optimization.png" alt="Continuous Performance Optimization" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700" />
                            </div>
                        </div>
                    </div>
                </div>
