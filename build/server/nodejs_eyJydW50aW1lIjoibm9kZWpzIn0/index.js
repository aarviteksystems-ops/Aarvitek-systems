...
function Layout({
  ...
  return /* @__PURE__ */ jsxs("html", {
    ...
    children: [/* @__PURE__ */ jsxs("head", {
      children: [gtmId && /* @__PURE__ */ jsx("script", {
        dangerouslySetInnerHTML: {
